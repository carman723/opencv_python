...
largura_min=80 #Largura minima de retangulo
altura_min=80 #Altura minima de retangulo
...
while True:
    ...
    cv2.putText(frame1, "Vehiculos: "+str(carros), (450, 70), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255),5)
